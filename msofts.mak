#
# nmake Makefile for netcdf fortran static library
# JCaron 3/18/98
...
LIBMAKE=lib.exe
$(LIBRARY): $(LIB_OBJS)
    $(LIBMAKE) /out:$(LIBRARY) $(CLIB_OBJS) $(LIB_OBJS)

test:	ftest.exe
	.\ftest.exe

ftest.exe: ftest.obj $(LIBRARY)
	$(FOR) $(FFLAGS) ftest.obj /link $(LIBRARY) /NODEFAULTLIB:libcmt /out:$@
...
clean:
	-@erase *.obj *.for ftest.exe test.nc copy.nc > NUL 2>&1
